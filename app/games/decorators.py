...
def playerInGame(f):
    ...
    async def fWrapper(*args, **kargs):
        ...
        if 'schema' in kargs:
            playerId = kargs['schema'].playerId
        else:
            playerId = kargs['playerId']
